      ...
      <div className="name-container">
        ...
        <nav className="contact-list">
          <a
            ...
            href="mailto:laurenwalters@creighton.edu"
          >
            <svg
              role="img"
              viewBox="0 0 24 24"
          ...
          <a
            ...
            rel="noopener noreferrer"
            className="contact-item"
            href="https://www.linkedin.com/in/lauren-walters-6bb6752a7/"
          >
            <svg
              role="img"
              viewBox="0 0 24 24"
          ...
          <a
            ...
            rel="noopener noreferrer"
            className="contact-item"
            href="https://www.doximity.com/profiles/782a11fb-c859-4b55-96f8-87fd697b7319/edit"
          >
            <svg
              version="1.2"
              xmlns="http://www.w3.org/2000/svg"
